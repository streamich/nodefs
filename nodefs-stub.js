...
// This implements and empty `fs` module for use in environments that don't have a native `fs`
// module, for example, in a browser or to be able to use `nodefs` standalone.

// Basically, on every API call this module complains that "File is not found".
